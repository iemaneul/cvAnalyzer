...
import { compareAnalysisVersions, createAnalysis, deleteAnalysis, downloadAnalysisReport, getAnalysis, listAnalyses, previewResumeText } from '../controllers/analysis.controller.js';
