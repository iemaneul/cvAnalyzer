...
import { compareAnalysisVersions, createAnalysis, deleteAnalysis, downloadAnalysisReport, exportAnalysesCsv, getAnalysis, getAnalysisDashboard, listAnalyses, previewResumeText, updateAnalysisContext, updateApplicationDetails, updateApplicationStatus } from '../controllers/analysis.controller.js';
...
analysisRouter.get('/analyses/export', exportAnalysesCsv);
